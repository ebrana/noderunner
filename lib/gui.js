...
Gui.prototype.run = function () {
  ...
  io.on('connection', function (socket) {
    ...
    self.emit(socket, 'freeThreadsCountChanged', (self.queues.immediate.maxThreadsCount - self.queues.immediate.activeThreadsCount)+' / ' + self.queues.immediate.maxThreadsCount);
